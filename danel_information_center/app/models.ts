...
export interface LoginProperties {
    name: string; idNumber: string; phone?: string; mail?
...
export interface PerformanceSummaryValues {
    PerformanceFromYearStart?: number; Performancelast12Month?: number; Performancelast36Month?: number; PortfolioAmount?: number;
}
